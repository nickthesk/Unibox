...
#define SUCCESS_COLOR		Color_t(50, 255, 100, 255)
#define WARNING_COLOR		Color_t(255, 200, 0, 255)
#define ERROR_COLOR			Color_t(255, 50, 50, 255)
#define INFO_COLOR			Color_t(50, 150, 255, 255)
