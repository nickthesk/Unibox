...
enum ETFWeapons
{
	...
	Misc_t_Saxxy = 423,
	Misc_t_TheConscientiousObjector = 474,
	Misc_t_TheFreedomStaff = 880,
	Misc_t_TheBatOuttaHell = 939,
	Misc_t_TheMemoryMaker = 954,
	Misc_t_TheHamShank = 1013,
	Misc_t_TheNecroSmasher = 1123,
	Misc_t_TheCrossingGuard = 1127,
	Misc_t_PrinnyMachete = 30758
};
